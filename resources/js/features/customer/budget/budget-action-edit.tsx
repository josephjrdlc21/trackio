import { edit, deleteMethod } from "@/routes/customer/budget"
...
export default function BudgetAction({ id }: { id: number }) {
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    Deleting this budget will permanently remove it and all associated data. This action cannot be undone.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
