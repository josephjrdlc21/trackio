...
import { index, update } from "@/routes/customer/budget"
...
export default function BudgetEditForm({ budget, categories }: BudgetEditProps) {
    const form = useForm(
        {
            category: budget.category_id.toString(),
            amount: budget.amount,
            budget_date: toHtmlDate(budget.budget_date),
        }
    ) 
    ...
    return (
        <Card className="w-full mt-5 shadow-none">
            <CardHeader>
                ...
                <CardDescription>
                    Adjust your budget details to stay on track with your finances.
                </CardDescription>
