...
import { index, store } from "@/routes/customer/expense"
...
export default function ExpenseCreateForm({ categories }: ExpenseCreateProps) {
    const form = useForm(
        {
            category: '',
            amount: '',
    ...
    return (
        <Card className="w-full mt-5 shadow-none">
            <CardHeader>
                ...
                <CardDescription>
                    Add a new expense to monitor your spending and manage your finances.
                </CardDescription>
