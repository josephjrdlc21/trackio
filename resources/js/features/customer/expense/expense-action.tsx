import { edit, deleteMethod } from "@/routes/customer/expense"
...
export default function ExpenseAction({ id }: { id: number }) {
            ...
            <DropdownMenuContent align="end" className="md:w-[140px]">
                ...
                <DropdownMenuItem asChild className="md:px-4 md:py-2 cursor-pointer">
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle>Do you want to delete this expense?</AlertDialogTitle>
                                <AlertDialogDescription>
                                    Deleting this expense will permanently remove it and all associated data. This action cannot be undone.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
