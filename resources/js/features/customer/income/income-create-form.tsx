...
import { index, store } from "@/routes/customer/income"
...
export default function IncomeCreateForm({ categories }: IncomeCreateProps) {
    const form = useForm(
        {
            category: '',
            amount: '',
    ...
    return (
        <Card className="w-full mt-5">
            <CardHeader>
                ...
                <CardDescription>
                    Add a new income entry to track your earnings and manage your finances.
                </CardDescription>
