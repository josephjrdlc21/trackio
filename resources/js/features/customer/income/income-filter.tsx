import { IncomeFilterProps } from "@/types/customer/income"
import { index } from "@/routes/customer/income"
...
export default function IncomeFilter({ filters }: IncomeFilterProps) {
